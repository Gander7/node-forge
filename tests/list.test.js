...
describe('List Command', () => {
  ...
  test('list projects with number of complete', () => {
    ...
    expect(output.log.length).toEqual(13)
    expect(output.log[12]).toEqual(expect.stringContaining('work'))
    expect(output.log[12]).toEqual(expect.stringContaining('2/5'))
    expect(output.log[12]).toEqual(expect.stringContaining('40'))
    expect(output.log[12]).toEqual(expect.stringContaining('home'))
    expect(output.log[12]).toEqual(expect.stringContaining('1/2'))
    expect(output.log[12]).toEqual(expect.stringContaining('50'))
    expect(output.log[12]).toEqual(expect.stringContaining('other'))
    expect(output.log[12]).toEqual(expect.stringContaining('1/1'))
    expect(output.log[12]).toEqual(expect.stringContaining('100'))
  })
})
